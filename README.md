...
```xml
<log>
  <section_ name='My section with timestamp' timestamp='2019-06-01-Sat-13.13.14.758'>
    Section with timestamp.
  </section_>
  <section_ name='My section with duration' duration_seconds='0.511'>
    Section with duration.
  </section_>
  <section_ name='My section with both' timestamp='2019-06-01-Sat-13.13.15.270' duration_seconds='0.514'>
    Section with both.
  </section_>
</log>
```
...
<log>
  <section_ name='My unrescued section'>
    <uncaught_exception_ timestamp='2019-06-01-Sat-13.13.16.231' class='RuntimeError'>
      <message_>
        Boo!
      </message_>
      <backtrace_>
...
```xml
<log>
  <section_ name='Section with potpourri of arguments' a='0' b='1' timestamp='2019-06-01-Sat-13.13.13.120' c='2' d='3' duration_seconds='0.511'>
    Word More words
...
```xml
<log>
  <uncaught_exception_ timestamp='2019-06-01-Sat-13.13.11.258' class='RuntimeError'>
    <message_>
      Boo!
    </message_>
    <backtrace_>
...
```xml
<log>
  <uncaught_exception_ timestamp='2019-06-01-Sat-13.13.11.260' class='RuntimeError'>
    <message_>
      Boo!
    </message_>
    <backtrace_>
...
<log>
  ...
  <verdict_ method='verdict_assert_same?' outcome='failed' id='another_id' message='Another message'>
    ...
    <exception_ class='Minitest::Assertion' message='Expected # encoding: UTF-8\n&quot;foo&quot; (oid=28117700) to be the same as # encoding: UTF-8\n&quot;foo&quot; (oid=28117720).'>
      <backtrace_>
        <![CDATA[
