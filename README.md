...
```xml
<log>
  <section_ name='My section with timestamp' timestamp='2019-05-08-Wed-07.38.28.463'>
    Section with timestamp.
  </section_>
  <section_ name='My section with duration' duration_seconds='0.500'>
    Section with duration.
  </section_>
  <section_ name='My section with both' timestamp='2019-05-08-Wed-07.38.28.964' duration_seconds='0.500'>
    Section with both.
  </section_>
</log>
```
...
<log>
  <section_ name='My unrescued section'>
    <uncaught_exception_ timestamp='2019-05-08-Wed-07.38.29.897' class='RuntimeError'>
      <message_>
        Boo!
      </message_>
      <backtrace_>
...
```xml
<log>
  <section_ name='Section with potpourri of arguments' a='0' b='1' timestamp='2019-05-08-Wed-07.38.26.830' c='2' d='3' duration_seconds='0.501'>
    Word More words
...
<log>
  ...
  <verdict_ method='verdict_assert_same?' outcome='failed' id='another_id' message='Another message'>
    ...
    <exception_ class='Minitest::Assertion' message='Expected &quot;foo&quot; (oid=28262460) to be the same as &quot;foo&quot; (oid=28262480).'>
      <backtrace_>
        <![CDATA[
